...
void Ideal::ResourceManager::CreateEmptyTexture2D(std::shared_ptr<Ideal::D3D12Texture>& OutTexture, const uint32& Width, const uint32& Height, bool MakeRTV /*= false*/)
{
	if (!OutTexture)
	{
		OutTexture = std::make_shared<Ideal::D3D12Texture>();
