...
/// </summary>
void FileUtils::Open(std::wstring _filePath, FileMode _mode)
{
...
void FileUtils::Write(void* _data, uint32 _dataSize)
{
	// 오류 체크 변수
	uint32 numOfBytes = 0;
...
void FileUtils::Write(const std::string& _data)
{
...
void FileUtils::Read(void** _data, uint32 _dataSize)
{
	// 오류 체크 변수
	uint32 numOfBytes = 0;
...
void FileUtils::Read(std::string& _data)
{
